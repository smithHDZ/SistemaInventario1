...
namespace ProyectoVenta.Formularios
{
    public partial class frmRegistrarProducto : Form
    {
        ...
        private void frmRegistrarProducto_Load(object sender, EventArgs e)
        {
            ...
            CMBPasillo.Items.Add("A1");
            CMBPasillo.Items.Add("A2");
            CMBPasillo.Items.Add("B1");
            CMBPasillo.Items.Add("B2");
            CMBPasillo.Items.Add("C1");
            CMBPasillo.Items.Add("C2");
            CMBPasillo.Items.Add("D1");
            CMBPasillo.Items.Add("D2");

            for (int i = 0; i < 42; i++)
            {
                CMBRack.Items.Add("R"+(i+1));
            }
        ...
        private void btnguardar_Click(object sender, EventArgs e)
        {
            ...
            Producto obj = new Producto()
            {
                ...
                Almacen = CMBPasillo.Text +"-"+ CMBRack.Text
            };
