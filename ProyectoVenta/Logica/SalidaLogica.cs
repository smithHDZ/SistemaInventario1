        ...
        public int reducirStock(int idproducto,int cantidad, out string mensaje)
        {
            ...
            try
            {
                using (MySqlConnection conexion = new Conexion().AbrirConexion())
                {
                    ...
                    cmd.Parameters.Add(new MySqlParameter("@pidproducto", idproducto));
        ...
        public List<VistaSalida> Resumen(string fechainicio = "", string fechafin = "")
        {
            ...
            try
            {
                using (MySqlConnection conexion = new Conexion().AbrirConexion())
                {
                    ...
                    MySqlCommand cmd = new MySqlCommand(query.ToString(), conexion);
                    cmd.Parameters.Add(new MySqlParameter("@pfechainicio", fechainicio));
                    cmd.Parameters.Add(new MySqlParameter("@pfechafin", fechafin));
                    cmd.CommandType = System.Data.CommandType.Text;
        ...
        public Salida Obtener(string numerodocumento)
        {
            ...
            try
            {
                using (MySqlConnection conexion = new Conexion().AbrirConexion())
                {
                    ...
                    MySqlCommand cmd = new MySqlCommand(query.ToString(), conexion);
                    cmd.Parameters.Add(new MySqlParameter("@pnumero", numerodocumento));
                    cmd.CommandType = System.Data.CommandType.Text;
        ...
        public List<DetalleSalida> ListarDetalle(int idsalida)
        {
            ...
            try
            {
                ...
                using (MySqlConnection conexion = new Conexion().AbrirConexion())
                {
                    ...
                    MySqlCommand cmd = new MySqlCommand(query.ToString(), conexion);
                    cmd.Parameters.Add(new MySqlParameter("@pidsalida", idsalida));
                    cmd.CommandType = System.Data.CommandType.Text;
