        ...
        public List<Inventario> Resumen(string fechainicio = "", string fechafin = "")
        {
            ...
            try
            {
                using (MySqlConnection conexion = new Conexion().AbrirConexion())
                {
                    ...
                    cmd.Parameters.Add(new MySqlParameter("@pfechainicio1", fechainicio));
                    cmd.Parameters.Add(new MySqlParameter("@pfechafin1", fechafin));
                    cmd.Parameters.Add(new MySqlParameter("@pfechainicio2", fechainicio));
                    cmd.Parameters.Add(new MySqlParameter("@pfechafin2", fechafin));
                    cmd.Parameters.Add(new MySqlParameter("@pfechainicio3", fechainicio));
                    cmd.Parameters.Add(new MySqlParameter("@pfechafin3", fechafin));
                    cmd.Parameters.Add(new MySqlParameter("@pfechainicio4", fechainicio));
                    cmd.Parameters.Add(new MySqlParameter("@pfechafin4", fechafin));
