        ...
        public int Guardar(Datos objeto, out string mensaje)
        {
            ...
            try
            {
                ...
                using (MySqlConnection conexion = new Conexion().AbrirConexion())
                {
                    ...
                    cmd.Parameters.Add(new MySqlParameter("@prazonsocial", objeto.RazonSocial));
                    cmd.Parameters.Add(new MySqlParameter("@pruc", objeto.RUC));
                    cmd.Parameters.Add(new MySqlParameter("@pdireccion", objeto.Direccion));
                    cmd.CommandType = System.Data.CommandType.Text;
        ...
        public int ActualizarLogo(byte[] imagen, out string mensaje)
        {
            ...
            try
            {
                ...
                using (MySqlConnection conexion = new Conexion().AbrirConexion())
                {
                    ...
                    MySqlCommand cmd = new MySqlCommand(query.ToString(), conexion);
                    MySqlParameter parameter = new MySqlParameter("@pimagen", System.Data.DbType.Binary);
